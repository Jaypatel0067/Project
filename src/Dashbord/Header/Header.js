...
function Header(props) {
  ...
  function scrollFunction() {
    if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
      ...
      document.getElementById("navbar").classList.add('w-full')
      
     
    } else {
      document.getElementById("navbar").classList.remove('fixed')
      document.getElementById("navbar").classList.remove('z-10')
      document.getElementById("navbar").classList.remove('w-full')
    }
  }
  

  return (
    <div className="bg-gray-900 transition-all shadow z-index-2" id="navbar">
      {/* Mobile menu */}
            ...
            <div className="h-16 flex items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {!(props.Sign_user && props.Sign_user.userAuth === null) ? (
                    <button onClick={() => auth.signOut()}> {props.Sign_user && props.Sign_user.displayName} - Sign Out</button>
                  ) : (
